"""
This scripts reads the analytics files generated by the crawler 
and prints out the answers to the questions in the assignment. 
It assumes that the crawler has been run and that the analytics files are present in the "analytics" directory.
"""
